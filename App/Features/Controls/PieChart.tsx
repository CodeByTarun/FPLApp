            ...
            {(dimensions != [0,0]) && 
                <Svg width={dimensions[0]} height={dimensions[1]} style={{alignSelf: 'center', position: 'absolute', transform: [{scaleX: isFirstValueEqualOrBigger ? 1 : -1}]}}>
                    <Circle cx={dimensions[0] / 2} cy={dimensions[1] / 2} r={radius} 
                            stroke={(props.firstStatValue === 0 && props.secondStatValue === 0) ? 'gray' : (isFirstValueEqualOrBigger ? props.secondStatColor : props.firstStatColor)} strokeWidth={9}/>
                    <Circle cx={dimensions[0] / 2} cy={dimensions[1] / 2} r={radius} 
                            stroke={(props.firstStatValue === 0 && props.secondStatValue === 0) ? 'gray' : isFirstValueEqualOrBigger ? props.firstStatColor : props.secondStatColor} strokeWidth={9} 
