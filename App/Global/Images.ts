...
export const Emblems: { [key: number]: ImageURISource} = 
    {
        1 : require('../../assets/emblems/t1.png'),
        2 : require('../../assets/emblems/t2.png'),
        3 : require('../../assets/emblems/t3.png'),
        4 : require('../../assets/emblems/t4.png'),
        6 : require('../../assets/emblems/t6.png'),
        7 : require('../../assets/emblems/t7.png'),
        8 : require('../../assets/emblems/t8.png'),
    ...
    export const Jerseys: { [key: number]: ImageURISource} = 
    {
        ...
        3 : require('../../assets/jerseys/3.png'),
        4 : require('../../assets/jerseys/4.png'),
        6 : require('../../assets/jerseys/6.png'),
        7 : require('../../assets/jerseys/7.png'),
        8 : require('../../assets/jerseys/8.png'),
