...
let dreamTeamInfo: DreamTeamInfo = { gameweek: 32, liveGameweek: 32, teamType: TeamTypes.Dream};
let fixtureInfo: FixtureInfo = { gameweek: 32, liveGameweek: 32, isHome: true, fixture:  gameweek32Fixture, teamType: TeamTypes.Fixture }

let draftInfoCurrentGameweek: DraftInfo = { gameweek: 33, liveGameweek: 33, info: { id: 61187, isDraftTeam: true, isFavourite: true, name: 'Tarun' }, teamType: TeamTypes.Draft };


let gameweekGreaterThanCurrentGameweekTeamInfo: DreamTeamInfo = {gameweek: 32, liveGameweek: 31, teamType: TeamTypes.Dream};

test('team type is draft', () => {

    const {queryByTestId, queryAllByTestId, rerender} = reduxRender(<Lineup overview={overview} teamInfo={draftInfo} fixtures={fixtures} gameweek={gameweek32}
...
test('team type is budget', () => {
    ...
    const {queryByTestId, queryAllByTestId} = reduxRender(<Lineup overview={overview} teamInfo={budgetInfo} fixtures={fixtures} gameweek={gameweek32}
                                                                       draftGameweekPicks={draftLeaguePicks} draftOverview={draftOverview} budgetGameweekPicks={budgetLeaguePicks}
                                                                       budgetUserInfo={budgetManagerInfo} draftUserInfo={draftManagerInfo}/>);
...
test('team type is dream team', () => {
    ...
    const {queryByTestId, queryAllByTestId} = reduxRender(<Lineup overview={overview} teamInfo={dreamTeamInfo} fixtures={fixtures} gameweek={gameweek32}
                                                             draftGameweekPicks={draftLeaguePicks} draftOverview={draftOverview} budgetGameweekPicks={budgetLeaguePicks}
                                                             budgetUserInfo={budgetManagerInfo} draftUserInfo={draftManagerInfo}/>);
...
test('team type is fixture', () => {
    ...
    const {queryByTestId, queryAllByTestId} = reduxRender(<Lineup overview={overview} teamInfo={fixtureInfo} fixtures={fixtures} gameweek={gameweek32}
                                                             draftGameweekPicks={draftLeaguePicks} draftOverview={draftOverview} budgetGameweekPicks={budgetLeaguePicks}
                                                             budgetUserInfo={budgetManagerInfo} draftUserInfo={draftManagerInfo}/>);
